window.onload = function() {
    ...
    document.getElementsByTagName("header")[0].innerHTML = `<div class="main-box">
...
document.getElementsByTagName("footer")[0].innerHTML = ` <div class="auto-container">
        ...
        <div class="column col-md-6 col-sm-6 col-xs-12">
            <div class="footer-widget links-widget">
                ...
                <div class="row clearfix">
                    <div class="column col-md-6 col-sm-6 col-xs-12">
                        <ul class="links">
                            <li> <a href="30-50-bpm.html"> Mineral Water Bottle Filling Machine </a></li>
                            <li> <a href="200-jph-jar-filling-machine.html"> Mineral Water Jar Filling Machine </a></li>
                            <li> <a href="automatic-volumetric-filling-machine.html"> Volumetric Filling Machine </a></li>
                            <li> <a href="fully-automatic-hot-fill-synthetic-juice-filling-machine-30-bpm-based-on-200-ml.html"> Juice Filling Machine </a></li>
                        </ul>
                    </div>
                    <div class="column col-md-6 col-sm-6 col-xs-12">
                        <ul class="links">
                            <li> <a href="automatic-bopp-labeling-machine-fsl-120-bpm.html"> Automatic BOPP Capping Machine </a></li>
                            <li> <a href=fully-automatic-shrink-wrapping-machine-fss-60-bpm.html"> Shrink Wrapping Machine </a></li>
                            <li> <a href="automatic-ropp-capping-machine.html"> ROPP Capping Machine </a></li>
                        </ul>
                    </div>
                </div>
            </div>
